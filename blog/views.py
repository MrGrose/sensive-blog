...
def index(request):
    ...
    most_popular_posts = Post.objects.prefetch_related('author').annotate(likes_count=Count('likes', distinct=True),comments_count=Count('comments', distinct=True)).order_by('-likes_count')[:5] 
